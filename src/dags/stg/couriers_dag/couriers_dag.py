...
from examples.stg.couriers_dag.couriers_loader import CouriersLoader  # Обновленный импорт для вашего модуля
...
@dag(
    ...
    tags=['sprint5', 'stg', 'couriers', 'example'],  # Теги для фильтрации в интерфейсе Airflow
    is_paused_upon_creation=True  # DAG будет в паузе при создании
)
def sprint5_example_stg_couriers_dag():
...
# Инициализация DAG
stg_couriers_dag = sprint5_example_stg_couriers_dag()
